...
{{Form::open(array('method'=>'put','route'=>array('inscription_etape1_update',Auth::user()->slug, $propriete->id)))}}
...
{{Form::text('nom_propriete', isset($propriete->nom) && Helpers::isOk($propriete->nom) ? $propriete->nom : (Session::has('input_2') ? Session::get('input_2')['nom_propriete']: '') ,array('placeholder'=>'Avana Mostra','required'))}}
<br/>
...
{{Form::select('type_propriete',$typeBatimentList,isset($propriete->type_batiment_id) && Helpers::isOk($propriete->type_batiment_id) ? $propriete->type_batiment_id : ( Session::has('input_2') ? Session::get('input_2')['type_propriete']: ''),array('class'=>'select','required'))}}

<br/>
{{Form::label('nb_personne',trans('form.enter_nb_personne'))}}
{{Form::input('number','nb_personne',isset($propriete->nb_personne) && Helpers::isOk($propriete->nb_personne) ? $propriete->nb_personne : (Session::has('input_2') ? Session::get('input_2')['nb_personne']: ''),array('min'=>'1','max'=>'20','required'))}}
<br/>
{{Form::label('nb_chambre',trans('form.enter_nb_chambre'))}}
{{Form::input('number','nb_chambre',isset($propriete->nb_chambre) && Helpers::isOk($propriete->nb_chambre) ? $propriete->nb_chambre : (Session::has('input_2') ? Session::get('input_2')['nb_chambre']: ''),array('min'=>'1','max'=>'20','required'))}}
<br/>
{{Form::label('nb_sdb',trans('form.enter_nb_sdb'))}}
{{Form::input('number','nb_sdb',isset($propriete->nb_sdb) && Helpers::isOk($propriete->nb_sdb) ? $propriete->nb_sdb :( Session::has('input_2') ? Session::get('input_2')['nb_sdb']: ''),array('min'=>'0','max'=>'20'))}}
<br/>
{{Form::label('etage',trans('form.enter_etage'))}}
{{Form::input('number','etage',isset($propriete->etage) && Helpers::isOk($propriete->etage) ? $propriete->etage : (Session::has('input_2') ? Session::get('input_2')['etage']: ''),array('min'=>'0','max'=> 10,'required'))}}

<br/>
{{Form::label('taille_interieur',trans('form.enter_int_size'))}}
{{Form::text('taille_interieur', isset($propriete->taille_bien) && Helpers::isOk($propriete->taille_bien) ? $propriete->taille_bien : (Session::has('input_2') ? Session::get('input_2')['taille_interieur']: ''),array('placeholder'=>'2','required'))}}
<span>m²</span>
<br/>
{{Form::label('taille_exterieur',trans('form.enter_ext_size'))}}
{{Form::text('taille_exterieur',isset($propriete->taille_terrain) && Helpers::isOk($propriete->taille_terrain) ? $propriete->taille_terrain : (Session::has('input_2') ? Session::get('input_2')['taille_exterieur']: ''),array('placeholder'=>'2'))}}
<span>m²</span>
<br/>
{{Form::label('exposition',trans('form.exposition'))}}
{{Form::select('exposition',trans('form.expositionList'),isset($propriete->exposition_id) && Helpers::isOk($propriete->exposition_id) ? $propriete->exposition_id : ( Session::has('input_2') ? Session::get('input_2')['exposition']: ''))}}
